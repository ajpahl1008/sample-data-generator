...
public class CreditCardTransactionEngine implements TransactionEngine {
    ...
    public CreditCardTransactionEngine() throws IOException {
        this.loadProperties();
    }
    ...
    public void run() {
        ...
        if (log.isInfoEnabled()) {
            log.info(MessageFormat.format("Starting Credit Card Transaction Engine {0}" , Thread.currentThread().getId()));
        }
