...
public class FradulentDebitTransactionEngine implements TransactionEngine {
    ...
    public FradulentDebitTransactionEngine() throws IOException {
        this.loadProperties();
    }
    ...
    public void run() {
        if (log.isInfoEnabled()) {
            log.info(MessageFormat.format("Starting Fraudulent Debit Card Transaction Engine %s" ,Thread.currentThread().getId()));
        }
